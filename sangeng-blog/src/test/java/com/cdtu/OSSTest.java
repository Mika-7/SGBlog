...
//        String bucket = "mika-sg-blog";
        ...
        String key = "2023/05/15/sg.png";
        try {
//            byte[] uploadBytes = "hello qiniu cloud".getBytes("utf-8");
//            ByteArrayInputStream byteInputStream=new ByteArrayInputStream(uploadBytes);
            InputStream inputStream = new FileInputStream("D:\\Temp File\\d30e04a0.jpg");
    ...
    public void testRef() {
        ...
        userInfoVo.setId(1L);
        // 对象是引用传值，函数内的更改会影响实参对象
        foo(userInfoVo);
        System.out.println("id: "+userInfoVo.getId());
    }
    private void foo(UserInfoVo userInfoVo) {
        userInfoVo.setId(2L);
    }
}
